class NapEvent
{
  ...
  int day; // Day of occurrence - abstracted the date recorded to be represented as a day of recording nap data.
  ...
  int quality; // How good was the nap? On a scale of 1-5
